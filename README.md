...
Compilation of some helpful R utility functions used in daily basis.
...
```
#### Web APIs and Apps
Use functions via Web API and Apps: https://sk-sahu.ocpu.io/sahu/www

> Web APIs and Apps are hosted on OpenCPU server.
